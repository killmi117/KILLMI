...
<script type="text/javascript"><!--
	...
	CrosswordHeight = 12;
	Words = 5;
	WordLength = new Array(5, 5, 8, 7, 10);
	Word = new Array("ASASS", "ACASF", "ASDSADAS", "ADADSAD", "DADCFXSVFG");
	Clue = new Array("asdasda", 
"asfsafsaf", 
"assddsadas", 
"asdsdad", 
"gdtfsasadasd");
	AnswerHash = new Array(11802, 35384, 48095, 3002, 55156);
	WordX = new Array(2, 0, 6, 2, 4);
	WordY = new Array(3, 10, 0, 1, 2);
